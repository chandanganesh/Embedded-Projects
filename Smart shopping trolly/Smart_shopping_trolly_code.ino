...
#include<Wire.h>
LiquidCrystal lcd(16,5,14,12,13,15);

const char* ssid = "xxxx";//Replace with your network SSID
...
void loop()
{
  ...
  if (Serial.available())
  {
    ...
    if (count == 12)
    {
      if ((strncmp(input, "030043D6D94F", 12) == 0) && (a == 1))
      {
        lcd.setCursor(0, 0);
      ...
      else if ((strncmp(input, "030043D6D94F", 12) == 0) && (a == 0))
      {
        if(p1>0)
        {
        lcd.clear();
      ...
      else if ((strncmp(input, "03003BB6EE60", 12) == 0) && (a == 1))
      {
        lcd.setCursor(0, 0);
      ...
      else if ((strncmp(input, "03003BB6EE60", 12) == 0) && (a == 0))
      {
         if(p2>0)
        {
        lcd.clear();
      ...
      else if ((strncmp(input, "03003A9CBC19", 12) == 0) && (a == 1))
      {
        lcd.setCursor(0, 0);
      ...
      else if ((strncmp(input, "03003A9CBC19", 12) == 0) && (a==0))
      {
        if(p3>0)
        {
        lcd.clear();
      ...
      else if ((strncmp(input, "03003BF511DC", 12) == 0) && (a == 1))
      {
        lcd.setCursor(0, 0);
      ...
      else if ((strncmp(input, "03003BF511DC", 12) == 0) && (a == 0))
      {
        if(p4>0)
        {
        lcd.clear();
      ...
      else if (strncmp(input, "030043D98D14", 12) == 0)
      {
        lcd.clear();
        lcd.setCursor(0, 0);
